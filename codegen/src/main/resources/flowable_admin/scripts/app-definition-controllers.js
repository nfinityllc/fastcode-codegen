...
flowableAdminApp.controller('AppDefinitionController', ['$scope', '$rootScope', '$http', '$timeout','$location','$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.loadProcessDefinitions = function() {
            ...
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/app-definitions/' + $scope.definition.id +'/process-definitions?deploymentId=' + $scope.definition.deploymentId}).
        ...
        $scope.loadCaseDefinitions = function() {
            ...
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/app-definitions/' + $scope.definition.id +'/case-definitions?deploymentId=' + $scope.definition.deploymentId}).
            success(function(data, status, headers, config) {
        ...
        $scope.loadDecisionTables = function() {
            ...
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/app-definitions/'+ $scope.definition.id + '/decision-tables?deploymentId=' + $scope.definition.deploymentId}).
            success(function(data, status, headers, config) {
        ...
        $scope.loadFormDefinitions = function() {
            ...
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/app-definitions/'+ $scope.definition.id + '/form-definitions?deploymentId=' + $scope.definition.deploymentId}).
            success(function(data, status, headers, config) {
		...
		$scope.executeWhenReady(function() {
		    // Load definition
		    $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/app-definitions/' + $routeParams.definitionId}).
		    success(function(data, status, headers, config) {

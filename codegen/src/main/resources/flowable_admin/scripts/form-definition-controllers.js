    ...
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
       ...
       $scope.openDeployment = function(deploymentId) {
        ...
        $scope.executeWhenReady(function () {
            // Load form
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-definitions/' + $routeParams.formId}).
            success(function (data, status, headers, config) {
                ...
                $http({
                    method: 'GET',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-definition-form-instances/' + $routeParams.formId
                }).
    ...
    ['$rootScope', '$scope', '$modalInstance', '$http', 'form', '$timeout', '$translate', 'uiGridConstants',
        function ($rootScope, $scope, $modalInstance, $http, form, $timeout, $translate, uiGridConstants) {
            ...
            $scope.executeWhenReady(function () {
                ...
                $http({
                    method: 'GET',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-definitions/' + form.id + '/editorJson'
                }).
                success(function (data, status, headers, config) {

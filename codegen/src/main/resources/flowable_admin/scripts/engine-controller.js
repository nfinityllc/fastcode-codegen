    ...
    function ($rootScope, $scope, $http, $timeout, $modal, $translate) {
        ...
        var editEndpointConfig = function (endpointType) {
            ...
            if (selectedServer) {
                ...
                $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/server-configs/default/'+endpointType}).
        ...
        var checkEndpointConfig = function (endpointType) {
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/engine-info/'+endpointType,
                ignoreErrors: true
...
flowableAdminApp.controller('EditEndpointConfigModalInstanceCtrl',
    ['$scope', '$modalInstance', '$http', 'server', function ($scope, $modalInstance, $http, server) {
        ...
        $scope.ok = function () {
            ...
            var serverConfigUrl = FlowableAdmin.Config.baseUrl + '/app/rest/server-configs';
            var method = 'PUT';

...
flowableAdminApp.controller('CaseInstanceController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.loadCaseDefinition = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-definitions/' + $scope.caseInstance.caseDefinitionId
        ...
        $scope.loadCaseInstance = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $routeParams.caseInstanceId
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadTasks = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $scope.caseInstance.id + '/tasks'
            }).success(function (data, status, headers, config) {
                $scope.tasks = data;
        ...
        $scope.loadVariables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $scope.caseInstance.id + '/variables'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadJobs = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $scope.caseInstance.id + '/jobs'
            }).success(function (data, status, headers, config) {
                $scope.jobs = data;
        ...
        $scope.loadDecisionTables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $scope.caseInstance.id + '/decision-executions'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadFormInstances = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-form-instances/' + $scope.caseInstance.id
...
flowableAdminApp.controller('DeleteCaseModalInstanceCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'caseInstance', 'action', function ($rootScope, $scope, $modalInstance, $http, caseInstance, action) {
        ...
        $scope.ok = function () {
            ...
            $http({
                method: 'POST', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + $scope.caseInstance.id,
                data: dataForPost
            }).success(function (data, status, headers, config) {
...
flowableAdminApp.controller('UpdateCaseInstanceVariableCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'variable', 'caseInstanceId', function ($rootScope, $scope, $modalInstance, $http, variable, caseInstanceId) {
        ...
        $scope.executeUpdateVariable = function () {
            ...
            $http({
                method: 'PUT',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + caseInstanceId + '/variables/' + $scope.updateVariable.name,
                data: dataForPut
            }).success(function (data, status, headers, config) {
                $modalInstance.close(true);
                $scope.status.loading = false;
    ...
    ['$rootScope', '$scope', '$modalInstance', '$http', 'variable', 'caseInstanceId',
        function ($rootScope, $scope, $modalInstance, $http, variable, caseInstanceId) {
            ...
            $scope.deleteVariable = function () {
                $http({
                    method: 'DELETE',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + caseInstanceId + '/variables/' + $scope.variable.name
                }).success(function (data, status, headers, config) {
                    $modalInstance.close(true);
                    $scope.status.loading = false;
                }).error(function (data, status, headers, config) {
    ...
    ['$rootScope', '$scope', '$modalInstance', '$http', 'caseInstanceId',
        function ($rootScope, $scope, $modalInstance, $http, caseInstanceId) {
            ...
            $scope.createVariable = function () {
                ...
                $http({
                    method: 'POST',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/case-instances/' + caseInstanceId + '/variables',
                    data: data
                }).success(function (data, status, headers, config) {
                    $modalInstance.close(true);
                    $scope.status.loading = false;

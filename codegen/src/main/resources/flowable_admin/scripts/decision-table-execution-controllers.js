...
flowableAdminApp.controller('DecisionTableExecutionController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q) {
        ...
        $scope.executeWhenReady(function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/decision-tables/history/' + $routeParams.executionId
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/decision-tables/history/' + $routeParams.executionId + '/auditdata'
            }).success(function (data, status, headers, config) {

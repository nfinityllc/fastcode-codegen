<div class="container">
	<mat-toolbar class="action-tool-bar" color="primary">
		...
		<button mat-flat-button (click)="itemNgForm.ngSubmit.emit()"
			[disabled]="!itemForm.valid || loading">Save</button>
	</mat-toolbar>
	<mat-card>
		<h2>{{title}}</h2>
		<form [formGroup]="itemForm" #itemNgForm="ngForm" (ngSubmit)="onSubmit()" class="item-form">
			...
			<mat-form-field>
				...
				<mat-error *ngIf="!itemForm.get('firstName').valid && itemForm.get('firstName').touched">firstName is
					required</mat-error>
			</mat-form-field>

			<mat-form-field>
				<input formControlName="lastName" matInput placeholder="Enter lastName">
				<mat-error *ngIf="!itemForm.get('lastName').valid && itemForm.get('lastName').touched">lastName is
					required</mat-error>
			</mat-form-field>
			...
			<mat-form-field>
				...
				<mat-error *ngIf="!itemForm.get('emailAddress').valid && itemForm.get('emailAddress').touched">
					emailAddress is required</mat-error>
			</mat-form-field>

			<mat-form-field>
				<input formControlName="userName" matInput placeholder="Enter userName">
				<mat-error *ngIf="!itemForm.get('userName').valid && itemForm.get('userName').touched">userName is
					required</mat-error>
			</mat-form-field>

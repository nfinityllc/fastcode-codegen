...
import static [=PackageName].emailConverter.utils.CommonUtil.checkValue;
...
import [=PackageName].emailConverter.dto.request.Background;
import [=PackageName].emailConverter.dto.request.Border;
import [=PackageName].emailConverter.dto.request.Elements;
import [=PackageName].emailConverter.dto.request.Height;
import [=PackageName].emailConverter.dto.request.LineHeight;
import [=PackageName].emailConverter.dto.request.Options;
import [=PackageName].emailConverter.dto.request.Padding;
import [=PackageName].emailConverter.dto.request.Request;
import [=PackageName].emailConverter.dto.request.Size;
import [=PackageName].emailConverter.dto.request.Structures;
import [=PackageName].emailConverter.dto.request.Width;
...
public class EmailMjmlTemplateGenrator {
	...
	private String text2String(String path) throws IOException {
		File classPathResource = new File(path);
		if (!classPathResource.exists()) {
			return "";
		}
		try {
			return Files.lines(classPathResource.toPath()).collect(Collectors.joining(System.lineSeparator()));
		} catch (IOException e) {

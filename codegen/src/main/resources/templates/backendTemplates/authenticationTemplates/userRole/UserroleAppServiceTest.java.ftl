...
public class [=AuthenticationTable]roleAppServiceTest {
    ...
    @Test
	public void create[=AuthenticationTable]role_[=AuthenticationTable]roleIsNotNullAnd[=AuthenticationTable]roleDoesNotExistAndChildIsNullAndChildIsNotMandatory_Store[=AuthenticationTable]role() {
    ...
    @Test
	public void update[=AuthenticationTable]role_[=AuthenticationTable]roleIsNotNullAnd[=AuthenticationTable]roleDoesNotExistAndChildIsNullAndChildIsNotMandatory_ReturnUpdated[=AuthenticationTable]role() {
	...
	@Test
	public void update[=AuthenticationTable]role_[=AuthenticationTable]roleIdIsNotNullAndIdExists_ReturnUpdated[=AuthenticationTable]role() {

...
describe('EmailTemplateListComponent', () => {
  ...
  let component:List;
  let data:IITem[] = [{id:1,templateName:'name1',category:"category1",contentHtml:"html",contentJson:"json",to:"to",cc:"",bcc:"bcc",subject:"subject"},
  {id:2,templateName:'name2',category:"category2",contentHtml:"html2",contentJson:"json2",to:"to2",cc:"",bcc:"bcc2",subject:"subject2"},
];    
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [
        List  ,UserNewComponent,PickerComponent      
      ],

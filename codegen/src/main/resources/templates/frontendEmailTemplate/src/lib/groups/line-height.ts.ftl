    ...
    <div class="group">
      <mat-form-field appearance="outline">
        ...
        <input matInput [(ngModel)]="lineHeight.value" type="number" step="1"
          placeholder="{{'GROUPS.LINE-HEIGHT.FIELDS.LINE-HEIGHT' | translate}}" [disabled]="lineHeight.unit === 'none'">
      </mat-form-field>
      <mat-form-field appearance="outline">
        <mat-label>{{'GROUPS.LINE-HEIGHT.FIELDS.UNIT' | translate}}</mat-label>
        <mat-select placeholder="{{'GROUPS.LINE-HEIGHT.FIELDS.UNIT' | translate}}" [(value)]="lineHeight.unit" disableRipple>

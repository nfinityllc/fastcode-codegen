  ...
  template: `
    <div class="group">
      <mat-form-field appearance="outline" *ngIf="font.family">
        ...
        <mat-select placeholder="{{'GROUPS.FONT-STYLES.FIELDS.FAMILY' | translate}}" [(value)]="font.family" disableRipple>
      ...
      <mat-form-field appearance="outline" *ngIf="font.style">
        ...
        <mat-select placeholder="{{'GROUPS.FONT-STYLES.FIELDS.STYLE' | translate}}" [(value)]="font.style" disableRipple>
    ...
    <div class="group">
      <mat-form-field appearance="outline" *ngIf="font.weight">
        ...
        <mat-select placeholder="{{'GROUPS.FONT-STYLES.FIELDS.WEIGHT' | translate}}" [(value)]="font.weight" disableRipple>
      ...
      <mat-form-field appearance="outline" *ngIf="font.size">
        ...
        <input matInput placeholder="{{'GROUPS.FONT-STYLES.FIELDS.SIZE' | translate}}" type="number" max="30" min="10" step="1" [(ngModel)]="font.size" />
      </mat-form-field>
    </div>
  `,
  styles: []

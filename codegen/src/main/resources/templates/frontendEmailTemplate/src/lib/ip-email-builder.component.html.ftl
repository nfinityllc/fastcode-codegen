            ...
            <ip-structure [structure]="structure" [ngClass]="{active: (currentEditingStructure$ | async) === structure}"
              ...
              <div class="tools" fxLayout fxLayoutGap="0.2em">
                <button mat-icon-button (click)="editStructure(structure)" color="primary"
                  ...
                  <mat-icon attr.aria-label="{{'EMAIL-BUILDER.STRUCTURE.CHANGE-SETTING-ARIA-LABEL' | translate}}">edit
                  </mat-icon>
                </button>
                <button mat-icon-button *ngIf="email.structures.length > 1" class="structure-move"
                  ...
                  <mat-icon attr.aria-label="{{'EMAIL-BUILDER.STRUCTURE.CHANGE-ORDER-ARIA-LABEL' | translate}}">pan_tool
                  </mat-icon>
                </button>
                <button mat-icon-button (click)="duplicateStructure(structure, key)"
                  matTooltip="{{'EMAIL-BUILDER.STRUCTURE.DUPLICATE-TOOLTIP' | translate}}">
                  <mat-icon attr.aria-label="{{'EMAIL-BUILDER.STRUCTURE.DUPLICATE-ARIA-LABEL' | translate}}">file_copy
                  </mat-icon>
                </button>
            ...
            <div class="editing-element-options">
              <mat-form-field appearance="outline">
                ...
                <input matInput [(ngModel)]="structure.options.background.url" type="url"
                  placeholder="{{'EMAIL-BUILDER.CONTENT.DRAG-AND-DROP-SECTIONS.BACKGROUND-IMAGE-LABEL' | translate}}">
              </mat-form-field>
              <div class="group two">
          ...
          <div *ngIf="currentEditingBlock$ | async as block" fxLayout="column">
            ...
            <div class="editing-element-options">
              ...
              <ng-container *ngIf="block.type === 'image'">
                ...
                <ip-width-height [model]="block.options.width" label="{{'EMAIL-BUILDER.CONTENT.DRAG-AND-DROP-CONTENT.IMAGE.WIDTH-LABEL' | translate}}"></ip-width-height>
                <ip-width-height [model]="block.options.height" label="{{'EMAIL-BUILDER.CONTENT.DRAG-AND-DROP-CONTENT.IMAGE.HEIGHT-LABEL' | translate}}"></ip-width-height>

...
public class EmailModuleTemplateGenerator {
	...
	public static void generateEmailModuleClasses(String destination,String frontendDestination,String clientSubfolder, String packageName,Boolean history,
		...
		generateFiles(getTemplates(FRONTEND_EMAIL_TEMPLATE_FOLDER, history), root, frontendDestination);
		generateFiles(getTemplates(BACKEND_EMAIL_TEMPLATE_FOLDER, history), root, backendAppFolder);

	}
	
	
	private static Map<String, Object> getTemplates(String path, Boolean history){

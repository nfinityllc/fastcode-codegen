...
public class CodegenApplication{
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		List<String> relationInputList= GetUserInput.getRelationInput(classList, relationClassList, workingDir,packageName,scanner);
		...
		for(String str : classList)
		{
			if(!relationClassList.contains(str))
			{
				...
				EntityGenerator.Generate(className,details,input.getSchemaName(),input.getPackageName(),input.getDestinationPath(),relationInputList,input.getAudit());

...
public class EntityGenerator {
	...
	public static void Generate(String entityName,EntityDetails entityDetails,String schemaName,String packageName,String destPath,List<String> relationInput,Boolean audit) {

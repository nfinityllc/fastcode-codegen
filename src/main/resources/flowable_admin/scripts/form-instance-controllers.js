...
flowableAdminApp.controller('FormInstanceController', ['$rootScope', '$scope', '$http', '$timeout', '$location', '$translate', '$q', '$modal', '$routeParams',
    function ($rootScope, $scope, $http, $timeout, $location, $translate, $q, $modal, $routeParams) {
        ...
        $scope.executeWhenReady(function () {
            ...
            // Load submitted form
            $http({method: 'GET', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-instances/' + $routeParams.formInstanceId}).
            success(function (data, status, headers, config) {
                ...
                $http({
                    method: 'GET',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-instances/' + $routeParams.formInstanceId + '/form-field-values/'
                }).
            ...
            function ($rootScope, $scope, $modalInstance, $http, form, $timeout, $translate, uiGridConstants) {
                ...
                $scope.executeWhenReady(function () {
                    if (!form.form) {
                        ...
                        $http({
                            method: 'GET',
                            url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/form-instances/' + form.id
                        }).
                        success(function (data, status, headers, config) {

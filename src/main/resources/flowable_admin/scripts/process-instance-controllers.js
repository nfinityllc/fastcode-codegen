...
flowableAdminApp.controller('ProcessInstanceController', ['$scope', '$rootScope', '$http', '$timeout', '$location', '$routeParams', '$modal', '$translate', '$q', 'gridConstants',
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q, gridConstants) {
        ...
        $scope.loadProcessDefinition = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-definitions/' + $scope.process.processDefinitionId
        ...
        $scope.loadProcessInstance = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $routeParams.processInstanceId
            }).success(function (data, status, headers, config) {
                $scope.process = data;
        ...
        $scope.loadTasks = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id + '/tasks'
            }).success(function (data, status, headers, config) {
                $scope.tasks = data;
        ...
        $scope.loadVariables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id + '/variables'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadSubProcesses = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id + '/subprocesses'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadJobs = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id + '/jobs'
            }).success(function (data, status, headers, config) {
                $scope.jobs = data;
        ...
        $scope.loadDecisionTables = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id + '/decision-executions'
            }).success(function (data, status, headers, config) {
        ...
        $scope.loadFormInstances = function () {
            ...
            $http({
                method: 'GET',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-form-instances/' + $scope.process.id
            }).success(function (data, status, headers, config) {
...
flowableAdminApp.controller('DeleteProcessModalInstanceCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'process', function ($rootScope, $scope, $modalInstance, $http, process, action) {
        ...
        $scope.ok = function () {
            ...
            $http({
                method: 'POST', url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + $scope.process.id,
                data: dataForPost
            }).success(function (data, status, headers, config) {
...
flowableAdminApp.controller('ShowProcessInstanceMigrationPopupCtrl',
    ...
    function ($rootScope, $scope, $modalInstance, $http, process, processDefinition, migrationScope) {
        ...
        $http({
            method: 'GET',
            url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-definitions?key=' + $scope.processDefinition.key
...
flowableAdminApp.controller('UpdateVariableCtrl',
    ['$rootScope', '$scope', '$modalInstance', '$http', 'variable', 'processInstanceId', function ($rootScope, $scope, $modalInstance, $http, variable, processInstanceId) {
        ...
        $scope.executeUpdateVariable = function () {
            ...
            $http({
                method: 'PUT',
                url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + processInstanceId + '/variables/' + $scope.updateVariable.name,
                data: dataForPut
            }).success(function (data, status, headers, config) {
                $modalInstance.close(true);
                $scope.status.loading = false;
    ...
    ['$rootScope', '$scope', '$modalInstance', '$http', 'variable', 'processInstanceId',
        function ($rootScope, $scope, $modalInstance, $http, variable, processInstanceId) {
            ...
            $scope.deleteVariable = function () {
                $http({
                    method: 'DELETE',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + processInstanceId + '/variables/' + $scope.variable.name
                }).success(function (data, status, headers, config) {
                    $modalInstance.close(true);
                    $scope.status.loading = false;
                }).error(function (data, status, headers, config) {
    ...
    ['$rootScope', '$scope', '$modalInstance', '$http', 'processInstanceId',
        function ($rootScope, $scope, $modalInstance, $http, processInstanceId) {
            ...
            $scope.createVariable = function () {
                ...
                $http({
                    method: 'POST',
                    url: FlowableAdmin.Config.baseUrl + '/app/rest/admin/process-instances/' + processInstanceId + '/variables',
                    data: data
                }).success(function (data, status, headers, config) {
                    $modalInstance.close(true);
                    $scope.status.loading = false;

...
import {IRolepermission,RolepermissionListComponent,RolepermissionService } from './index';
...
@Injectable()
class MockRolepermissionService { }
...
describe('RolepermissionListComponent', () => {
  ...
  beforeEach(() => {
    ...
    rolepermissionService = TestBed.get(RolepermissionService);
